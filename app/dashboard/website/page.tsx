...
const Generator: React.FC<{ initialData?: any }> = ({ initialData }) => {
  ...
  const [aiTone, setAiTone] = useState<
    "Heartfelt" | "Funny" | "Poetic" | "Professional" | "Playful"
  >(initialData?.aiTone || "Heartfelt");
  const [layout, setLayout] = useState<"classic" | "modern">(
    initialData?.layout === "modern" ? "modern" : "classic",
  );
