...
interface WebsiteFormProps {
  ...
  setAiTone: (
    val: "Heartfelt" | "Funny" | "Poetic" | "Professional" | "Playful",
  ) => void;
  layout: "classic" | "modern";
  setLayout: (val: "classic" | "modern") => void;
}
      ...
      <div className="flex flex-col space-y-2">
            ...
            [
              {
                value: "classic",
                label: "Classic",
                desc: "Solid colour header",
                preview: (
                  <div className="w-full h-10 rounded-sm bg-gradient-to-br from-[#9151FF] to-[#6a35c2]" />
                ),
              },
              {
                value: "modern",
                label: "Modern",
                desc: "Image + colour overlay",
                preview: (
                  <div className="relative w-full h-10 rounded-sm overflow-hidden bg-slate-200">
                    <div className="absolute inset-0 bg-[#9151FF]/60" />
        ...
        {layout === "modern" && images.length === 0 && (
          <p className="text-[9px] text-amber-600 font-bold">
            ⚠ Upload at least one image to use the Modern layout header.
          </p>
        )}
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="flex flex-col space-y-1.5">
          ...
          <Select value={language} onValueChange={setLanguage}>
            <SelectTrigger
              id="language"
              className="rounded-sm px-4 py-5.5 w-full border-2 border-[#191A23] text-[#191A23] text-sm focus:outline-none focus:ring-0 focus:shadow-[4px_4px_0px_0px_rgba(25,26,35,1)] hover:shadow-[4px_4px_0px_0px_rgba(25,26,35,1)] transition-all bg-white font-medium"
            >
              <SelectValue placeholder="Select a language" />
            </SelectTrigger>
            <SelectContent>
              {["English", "Yoruba", "Igbo", "Hausa", "Pidgin", "French"].map(
                (lang) => (
