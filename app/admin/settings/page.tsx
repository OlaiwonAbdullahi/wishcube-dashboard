  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm font-medium text-neutral-500 uppercase mt-1 tracking-wider">
            Configure platform-wide variables and permissions
          </p>
        </div>
      ...
      <div className="bg-white border-4 border-dashed border-[#191A23]/20 rounded-sm p-20 flex flex-col items-center justify-center text-center">
        <HugeiconsIcon icon={Settings01Icon} size={48} className="text-[#191A23]/20 mb-4" />
        <h2 className="text-xl font-black uppercase text-[#191A23]/40">Settings Console Coming Soon</h2>
        <p className="text-sm font-bold uppercase text-[#191A23]/20 mt-2">Integrating with the system configuration service...</p>
      </div>
    </div>
  );
}
